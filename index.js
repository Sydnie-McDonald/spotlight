...
export const printAddress = (obj) => {
  ...
  // console.log('test2', street, number, city, country);
...
//  getSum(1, 2, 3) === 6
//  getSum(1, 2, 3, 4, 5) === 15
export const getSum = (...numbers) => {// spread operator
  // numbers = [1, 2, 3, 4, 5];
  // passing in an array and spread which is being referenced. Then I started a count of 0 now I am iterating through the array adding the current index plus the following index and returning the final count. 
  let totalSum = 0;
